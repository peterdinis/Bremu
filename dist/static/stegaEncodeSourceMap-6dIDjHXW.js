import { c as H } from "./sanity-CLXDgs9T.js";
const D = /_key\s*==\s*['"](.*)['"]/;
function K(t) {
...
function ct(t, e, r) {
	...
	const o = { encoded: [], skipped: [] },
		p = Y(
			t,
			e,
			({ sourcePath: a, sourceDocument: _, resultPath: w, value: c }) => {
				if (
					(typeof i == "function"
						? i({
								sourcePath: a,
	...
	if (n) {
		...
		if (
			...
			for (const { path: c } of o.skipped)
				w.add(c.replace(D, "0").replace(/\[\d+\]/g, "[]"));
