...
function Y(y) {
	...
	t[6] !== o || t[7] !== n || t[8] !== d || t[9] !== u || t[10] !== I
		? ((p = (a, j) => {
				...
				if (a.type === "divider")
					return x.jsx(
						q,
						{ marginBottom: 1, children: x.jsx(M, {}) },
						`divider-${B}`,
					);
				const g = !d && o === a.id,
					w = d && o === a.id,
	...
	return (
		t[17] !== f || t[18] !== h
			? ((P = x.jsx(X, { overflow: f, children: h })),
				(t[17] = f),
				(t[18] = h),
				(t[19] = P))
			: (P = t[19]),
...
const z = (y) => {
	const t = L.c(11),
		...
		{ features: r } = D(),
		{ collapsed: i, isLast: b } = W(),
		c = b && !i ? -1 : 0;
	let n;
	t[0] !== d || t[1] !== e
		? ((n = x.jsx(K, { menuItems: e, menuItemGroups: d })),
			(t[0] = d),
			(t[1] = e),
			(t[2] = n))
		: (n = t[2]);
	let s;
	t[3] !== r.backButton || t[4] !== o
		? ((s =
				r.backButton &&
				o > 0 &&
				x.jsx(C, {
...
function O(y) {
	const t = L.c(21),
		...
		{ title: I } = T(r);
	let p;
	t[0] !== r.source ? ((p = $), (t[0] = r.source), (t[1] = p)) : (p = t[1]);
	let m;
	...
	let h;
	return (
		t[15] !== u || t[16] !== i || t[17] !== p || t[18] !== m || t[19] !== f
			? ((h = x.jsxs(A, {
					currentMaxWidth: 350,
