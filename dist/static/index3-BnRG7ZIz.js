const __vite__mapDeps = (
	...
	d = m.f ||
		(m.f = [
			"static/index-DGndIjH_.js",
			"static/sanity-CLXDgs9T.js",
			"static/index2-CResFlCf.js",
		]),
) => i.map((i) => d[i]);
import {
	b as $,
...
function St(t) {
	const e = $.c(60),
		...
		{ navigate: l, navigateIntent: d, resolvePathFromState: c } = fe(),
		u = ye(),
		{ panes: x, expand: I } = Ze();
	let f;
	f = (u == null ? void 0 : u.panes) || jt;
	const m = f;
	let P;
	...
	const g = P,
		h = o - 1;
	let y;
	e[0] !== h || e[1] !== m || e[2] !== u || e[3] !== s
		? ((y = (v) => {
				const j = m[h] || [],
					E = j[s],
					A = v(j, E),
					X = [...m.slice(0, h), A, ...m.slice(h + 1)];
				return { ...(u || {}), panes: X };
			}),
			(e[0] = h),
			(e[1] = m),
	...
	e[31] !== b || e[32] !== s
		? ((K = (v) => {
				b((j, E) => {
					...
					return [...j.slice(0, s), A, ...j.slice(s)];
				});
			}),
			(e[31] = b),
			(e[32] = s),
	...
	async function o({
		...
		return y.type === "document" && y.id === P
			? [
					{
						panes: [
							...u.slice(0, u.length - 1).map((_) => [{ id: _ }]),
...
function te({
	...
	try {
		return o(t, d, i.flatIndex).pipe(
			Ie((c) => {
				const u = { type: "resolvedMeta", ...i, paneNode: c, path: d.path },
					x = s.map((f, m) => ({
						type: "loading",
						path: [
							...d.path,
		...
		.pipe(
			...
			ve((o, a) => {
				const { cacheKeysByFlatIndex: i, resolvedPaneCache: s } = o,
					{ flattenedRouterPanes: l, diffIndex: d } = a,
					c = i.slice(0, d + 1),
					u = i.slice(d + 1),
					x = new Set(c.flatMap((f) => Array.from(f))),
					I = u.flatMap((f) => Array.from(f)).filter((f) => !x.has(f));
...
function Nt() {
	...
	let r, n;
	t[0] !== e
		? ((n = e.asObservable().pipe(G(Ot))), (t[0] = e), (t[1] = n))
		: (n = t[1]),
		(r = n);
	const o = r,
		{ state: a } = fe();
	...
	Ft = S.memo(() => {
		...
		return (
			t[0] !== a || t[1] !== r || t[2] !== e || t[3] !== n || t[4] !== o
				? ((l = () => {
						if (r) {
							const { intent: c, params: u, payload: x } = r;
							let I;
							return (
								(I = !1),
								(async () => {
									const { id: f, type: m } = await Ht(
										a,
										typeof u.id == "string" ? u.id : void 0,
										typeof u.type == "string" ? u.type : void 0,
									);
									if (I) return;
									const P = await Ct({
										intent: c,
										params: { ...u, id: f, type: m },
										payload: x,
										rootPaneNode: n,
										structureContext: o,
									});
...
function qt(t) {
	...
	e[0] !== n
		...
		: (s = e[1]);
	const l = s,
		d = (n instanceof de && n.helpId) || r.helpId,
		c = Qt;
	let u;
	e[2] !== o
		? ((u = o("structure-error.header.text")), (e[2] = o), (e[3] = u))
		: (u = e[3]);
	let x;
	e[4] !== u
		? ((x = p.jsx(He, { as: "h2", children: u })), (e[4] = u), (e[5] = x))
		: (x = e[5]);
	let I;
	e[6] !== l || e[7] !== o
		? ((I =
...
function Xt(t) {
	...
	let d;
	e[4] !== l
		? ((d = p.jsx(mt, { title: l })), (e[4] = l), (e[5] = d))
		: (d = e[5]);
	let c;
	e[6] !== s || e[7] !== i
		? ((c = p.jsx(ht, {
	...
	let u;
	return (
		e[9] !== r || e[10] !== o || e[11] !== d || e[12] !== c
			? ((u = p.jsxs(Xe, { id: o, selected: r, children: [d, c] })),
				(e[9] = r),
				(e[10] = o),
				(e[11] = d),
				(e[12] = c),
...
const Zt = {
		component: S.lazy(() =>
			Z(() => import("./index-DGndIjH_.js"), __vite__mapDeps([0, 1])),
		),
		document: S.lazy(() =>
			Z(() => import("./sanity-CLXDgs9T.js").then((t) => t.b1), []).then(
				(t) => t.pane,
			),
		),
		documentList: S.lazy(() =>
		...
		list: S.lazy(() =>
			Z(() => import("./index2-CResFlCf.js"), __vite__mapDeps([2, 1])),
		),
	},
	en = S.memo(
		(t) => {
			...
			let m;
			e[0] !== l || e[1] !== u || e[2] !== x
				? ((m = p.jsx(ge, { paneKey: l, path: u, selected: x })),
					(e[0] = l),
					(e[1] = u),
					(e[2] = x),
					(e[3] = m))
...
const nn = (t) => {
		const e = $.c(7),
			...
			c = i.get(n),
			{ value: u, isLoading: x } = ot({ enabled: !0, schemaType: c, value: d }),
			I = l
...
`,
	...
	dn = S.memo((t) => {
		...
		let L;
		e[14] !== d || e[15] !== s.length
			? ((L = s.length <= 1 && d && p.jsx(ge, { paneKey: "intent-resolver" })),
				(e[14] = d),
				(e[15] = s.length),
				(e[16] = L))
			: (L = e[16]);
...
function pn(t) {
	...
	return p.jsx(
		S.Fragment,
		{
			children:
				i === q
					? p.jsx(ge, { paneKey: a, path: d, selected: x })
					: p.jsx(en, {
							active: e,
							groupIndex: n,
							index: s,
...
function yn(t) {
	...
	const { source: s, defaultDocumentNode: l, structure: d } = i;
	let c;
