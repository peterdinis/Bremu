import { g as Ue } from "./sanity-CLXDgs9T.js";
function Ge(G, K) {
			...
			((G, K) => {
				((y) => {
					...
					if (
						...
						h == null && le != null && (h = () => new le("Microsoft.XMLHTTP")),
						Object.create == null &&
							(Object.create = (e) => {
								function r() {}
					...
					(j.prototype.open = function (e, r) {
						...
						this._abort = (i) => {
							this._sendTimeout !== 0 &&
								(_(this._sendTimeout), (this._sendTimeout = 0)),
								(o === 1 || o === 2 || o === 3) &&
									((o = 4),
									(t.onload = R),
									(t.onerror = R),
							...
							f = (i, l) => {
								if (
									...
									if (
										...
										this.onload(l);
									else if (i === "error") this.onerror(l);
									else if (i === "abort") this.onabort(l);
					...
					function ye(e) {
						return e.replace(/[A-Z]/g, (r) =>
							String.fromCharCode(r.charCodeAt(0) + 32),
						);
					}
					function ge(e) {
						for (
...
`),
					...
					function me() {}
					me.prototype.open = (e, r, n, t, o, a, s) => {
						var c = null,
							f = new te(),
							d = f.signal,
							u = new Y();
					...
					var ne = -1,
						...
						se = (e) => Math.min(Math.max(e, Le), je),
						X = (e, r, n) => {
							try {
