const e = {
	...
	"archive-dialog.confirm-archive-description_zero":
		"This will not archive any documents.",
	...
	"delete-dialog.confirm-delete.header":
		"Are you sure you want to delete the '{{title}}' release?",
	"delete-dialog.confirm-delete-description_zero":
	...
	"discard-version-dialog.header":
		"Are you sure you want to discard the document version?",
	...
	"toast.archive.success":
		"The '<strong>{{title}}</strong>' release was archived.",
	"toast.archive.error":
	...
	"toast.publish.success":
		"The '<strong>{{title}}</strong>' release was published.",
	...
	"toast.unschedule.success":
		"The '<strong>{{title}}</strong>' release was unscheduled.",
	"toast.unarchive.success":
		"The '<strong>{{title}}</strong>' release was unarchived.",
